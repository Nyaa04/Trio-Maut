...
<head>
    ...
    <link rel="stylesheet" href="viewSongstyle.css"> 
...
<body> 
	  <header>
        ...
        <nav class="navigation">
            ...
            <a href="viewSong.php" class="active">View Song</a>
        </nav>
 ...
 <?php 
  ...
  if ($conn->connect_error) {
    ...
    $searchCondition = "Song_Title LIKE '%$searchTerm%' OR Song_Artist LIKE '%$searchTerm%'";

    $queryView = "SELECT * FROM songs WHERE Approval_Status = 'Approved' AND ($searchCondition)";
    $resultQ = $conn->query($queryView);
}
?>
<div class="wrapper">
 <form method="GET" action="viewSong.php">
